...
export const DEFAULT_STORE_SETTINGS: StoreSettings = {
  ...
  billShowHelpline: true,
  billShowLogos: true,
  billShowTerms: true,
  billShowTagline: true,
  billShowOwnerName: true,
  billShowHsnColumn: true,
  billShowWords: true,
  billShowBankDetails: false,
  billShowWatermark: true,
  billWatermarkType: 'both',
  billWatermarkOpacity: 30,
  billWatermarkText: 'PRISHA STATIONERY & XEROX (THARAD)',
  hideUpiOnBill: false,
  showMrpOnStore: true,
